...
WAVE Tool's Reference material on Empty heading may not specifically address your problem.  We provide it here for optional reading.

??? Info "Click to see WAVE Tool Reference"

    This content added 2026-03-23. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#heading_empty" target="_blank">https://wave.webaim.org/api/docs?format=html#heading_empty</a>
...
The following material covers how the Project Team has provided a solution to the Empty heading WAVE Error.
