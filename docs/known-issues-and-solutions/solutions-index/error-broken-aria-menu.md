...
WAVE Tool's Reference material on Broken ARIA menu may not specifically address your problem.  We provide it here for optional reading.

??? Info "Click to see WAVE Tool Reference"

    This content added 2026-02-23. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#aria_menu_broken" target="_blank">https://wave.webaim.org/api/docs?format=html#aria_menu_broken</a>
...
The following material covers how the Project Team has provided a solution to the Broken ARIA menu WAVE Error.
