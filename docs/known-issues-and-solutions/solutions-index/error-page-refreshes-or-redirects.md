...
WAVE Tool's Reference material on Page refreshes or redirects may not specifically address your problem.  We provide it here for optional reading.

??? Info "Click to see WAVE Tool Reference"

    This content added 2026-04-09. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#meta_refresh" target="_blank">https://wave.webaim.org/api/docs?format=html#meta_refresh</a>
    ...
    > - [2.2.1 Timing Adjustable (Level A)](https://webaim.org/standards/wcag/checklist#sc2.2.1)
    > - [2.2.2 Pause, Stop, Hide (Level A)](https://webaim.org/standards/wcag/checklist#sc2.2.2)
...
The following material covers how the Project Team has provided a solution to the Page refreshes or redirects WAVE Error.
