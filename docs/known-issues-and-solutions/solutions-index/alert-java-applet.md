...
WAVE Tool's Reference material on Java applet may not specifically address your problem.  We provide it here for optional reading.

??? Info "Click to see WAVE Tool Reference"

    This content added 2026-04-01. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#applet" target="_blank">https://wave.webaim.org/api/docs?format=html#applet</a>
...
The following material covers how the Project Team has provided a solution to the Java applet WAVE Alert.
