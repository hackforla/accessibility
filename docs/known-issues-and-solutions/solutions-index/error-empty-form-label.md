...
WAVE Tool's Reference material on Empty form label may not specifically address your problem.  We provide it here for optional reading.

??? Info "Click to see WAVE Tool Reference"

    This content added 2026-02-23. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#label_empty" target="_blank">https://wave.webaim.org/api/docs?format=html#label_empty</a>
...
The following material covers how the Project Team has provided a solution to the Empty form label WAVE Error.
