...
- This is the same solution that libraries like `Bootstrap` use. <a href="https://getbootstrap.com/docs/5.0/getting-started/accessibility/">https://getbootstrap.com/docs/5.0/getting-started/accessibility</a>

- For more of a deep dive, this article shows how to create an sr-only class  <a href="https://kinaole.co/en/sr-only-just-a-class/">https://kinaole.co/en/sr-only-just-a-class</a>
