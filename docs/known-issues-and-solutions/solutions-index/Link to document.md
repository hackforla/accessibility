...
WAVE Tool's Reference material on Link to document may not specifically address your problem.  We provide it here for optional reading.
...
The following material covers how the Project Team has provided a solution to the Link to document WAVE Alert.
