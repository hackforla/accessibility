...
WAVE Tool's Reference material on Broken skip link may not specifically address your problem.  We provide it here for optional reading.

??? Info "Click to see WAVE Tool Reference"

    This content added 2026-03-23. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#link_skip_broken
" target="_blank">https://wave.webaim.org/api/docs?format=html#link_skip_broken</a>
...
The following material covers how the Project Team has provided a solution to the Broken skip link WAVE Error.
