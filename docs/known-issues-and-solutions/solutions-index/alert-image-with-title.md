...
WAVE Tool's Reference material on Image with title may not specifically address your problem.  We provide it here for optional reading.

??? Info "Click to see WAVE Tool Reference"

    This content added 2026-03-27. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#image_title" target="_blank">https://wave.webaim.org/api/docs?format=html#image_title</a>
...
The following material covers how the Project Team has provided a solution to the Image with title WAVE Alert.
