...
??? Info "Click to see WAVE Tool Reference"
    ...
    This content added 2026-04-03. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#text_justified" target="_blank">https://wave.webaim.org/api/docs?format=html#text_justified</a>
