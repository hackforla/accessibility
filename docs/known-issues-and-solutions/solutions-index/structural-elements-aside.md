...
WAVE Tool's Reference material on Aside may not specifically address your problem.  We provide it here for optional reading.

??? Info "Click to see WAVE Tool Reference"

    This content added 2026-03-23. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#aside" target="_blank">https://wave.webaim.org/api/docs?format=html#aside</a>
