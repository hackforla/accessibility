...
??? Info "Click to see WAVE Tool Reference"
    ...
    This content added 2026-03-23. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#aria_hidden" target="_blank">https://wave.webaim.org/api/docs?format=html#aria_hidden</a>
