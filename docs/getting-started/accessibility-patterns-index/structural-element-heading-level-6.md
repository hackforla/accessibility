...
# Structural Element - Heading level 6
- WAVE Category: Structural Element
- WAVE ACCESSIBILITY PATTERN: Heading level 6
...
??? Info "Click to see WAVE Tool Reference"
    ...
    This content added 2026-04-27. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#h6" target="_blank">https://wave.webaim.org/api/docs?format=html#h6</a>
