...
# Structural Element - Heading level 5
- WAVE Category: Structural Element
- WAVE ACCESSIBILITY PATTERN: Heading level 5
...
This content added 2026-04-27. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#h5" target="_blank">https://wave.webaim.org/api/docs?format=html#h5</a>
