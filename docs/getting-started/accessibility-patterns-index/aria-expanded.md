...
??? Info "Click to see WAVE Tool Reference"
    ...
    This content added 2026-03-23. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#aria_expanded" target="_blank">https://wave.webaim.org/api/docs?format=html#aria_expanded</a>
...
The following material covers how the Project Team has provided a solution to the WAVE ARIA expanded.
