...
- WAVE ACCESSIBILITY PATTERN: Header
...
??? Info "Click to see WAVE Tool Reference"
    ...
    This content added 2026-04-27. Check for updated guidance at: <a href="https://wave.webaim.org/api/docs?format=html#header" target="_blank">https://wave.webaim.org/api/docs?format=html#header</a>
