...
- Only use this template if there is no solution in the index and there are two or more pages with the same error.  Check the [WIKI and Issue templates](index.md) list for the applicable issue template.
    - There will likely be a page in the index for this issue, please consult the [Known issues and solutions index](../solutions-index/known-issues-and-solutions), and identify if the page is in the Completed or Drafts section.  If it is in the Drafts section, there is no solution yet.
